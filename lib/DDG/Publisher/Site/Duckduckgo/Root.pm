		...
		yearly_donations => [{
			...
			donations => {
				col1 => [
					...
					{amount => '$68,012', recipient => 'Freedom of the Press Foundation', url => 'https://freedom.press'},
					{amount => '$48,022', recipient => 'Center for Democracy & Technology', url => 'https://cdt.org'},
					{amount => '$44,664', recipient => 'Fight for the Future', url => 'https://www.fightforthefuture.org'},
					{amount => '$38,081', recipient => 'Tails', url => 'https://tails.boum.org'},
					{amount => '$33,810', recipient => 'New Media Rights', url => 'https://www.newmediarights.org'},
					{amount => '$32,904', recipient => 'Restore the Fourth', url => 'https://restorethe4th.com'},
					{amount => '$22,816', recipient => 'Tor Project', url => 'https://www.torproject.org'},
					{amount => '$18,895', recipient => 'Terms of Service; Didn’t Read', url => 'https://tosdr.org'},
					{amount => '$14,325', recipient => 'The Calyx Institute', url => 'https://www.calyxinstitute.org'},
					{amount => '$14,236', recipient => 'Let’s Encrypt', url => 'https://letsencrypt.org'},
				],
				col2 => [
					{amount => '$11,561', recipient => 'Riseup Labs', url => 'https://riseuplabs.org'},
					{amount => '$11,533', recipient => 'Open Source Technology Improvement Fund (OSTIF)', url => 'https://ostif.org'},
					{amount => '$11,089', recipient => 'Internet Freedom Festival', url => 'https://internetfreedomfestival.org'},
					{amount => '$10,903', recipient => 'Access Now', url => 'https://www.accessnow.org'},
					{amount => '$10,401', recipient => 'Emerald Onion', url => 'https://emeraldonion.org'},
					{amount => '$9,079', recipient => 'Privacy Rights Clearinghouse', url => 'https://www.privacyrights.org'},
					{amount => '$6,634', recipient => 'Freenet Project', url => 'https://freenetproject.org'},
					{amount => '$6,929', recipient => 'American Civil Liberties Union (ACLU)', url => 'https://www.aclu.org'},
					{amount => '$5,273', recipient => 'Bits of Freedom', url => 'https://www.bof.nl/english'},
					{amount => '$4,265', recipient => 'World Privacy Forum', url => 'https://www.worldprivacyforum.org'},
				]
			}
		},{
			year => '2017',

		...
		yearly_donations => [{
			...
			donations => {
				col1 => [
					...
					{amount => '$48,021', recipient => 'Center for Democracy & Technology', url => 'https://cdt.org'},
					{amount => '$44,663', recipient => 'Fight for the Future', url => 'https://www.fightforthefuture.org'},
					{amount => '$38,080', recipient => 'Tails', url => 'https://tails.boum.org'},
					{amount => '$33,809', recipient => 'New Media Rights', url => 'https://www.newmediarights.org'},
					{amount => '$32,903', recipient => 'Restore the Fourth', url => 'https://restorethe4th.com'},
					{amount => '$22,815', recipient => 'Tor Project', url => 'https://www.torproject.org'},
				...
				col2 => [
					{amount => '$11,560', recipient => 'Riseup Labs', url => 'https://riseuplabs.org'},
					{amount => '$11,532', recipient => 'Open Source Technology Improvement Fund (OSTIF)', url => 'https://ostif.org'},
					{amount => '$11,088', recipient => 'Internet Freedom Festival', url => 'https://internetfreedomfestival.org'},
					...
					{amount => '$9,078', recipient => 'Privacy Rights Clearinghouse', url => 'https://www.privacyrights.org'},
					{amount => '$6,633', recipient => 'Freenet Project', url => 'https://freenetproject.org'},
					{amount => '$6,928', recipient => 'American Civil Liberties Union (ACLU)', url => 'https://www.aclu.org'},
					{amount => '$5,272', recipient => 'Bits of Freedom', url => 'https://www.bof.nl/english'},
					{amount => '$4,263', recipient => 'World Privacy Forum', url => 'https://www.worldprivacyforum.org'},
				]
			}
		},{
			year => '2017',

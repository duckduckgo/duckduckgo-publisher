...
sub pages {{
	...
	donations => sub {
		...
		yearly_donations => [{
			...
			donations => {
				col1 => [
					{amount => '$10,903.07', recipient => 'Access Now', url => 'https://www.accessnow.org'},
					{amount => '$6,928.78', recipient => 'American Civil Liberties Union (ACLU)', url => 'https://www.aclu.org'},
					{amount => '$5,272.82', recipient => 'Bits of Freedom', url => 'https://www.bof.nl/english'},
					{amount => '$48,021.72', recipient => 'Center for Democracy & Technology', url => 'https://cdt.org'},
					{amount => '$76,571.28', recipient => 'Demand Progress', url => 'https://demandprogress.org'},
					{amount => '$10,401.30', recipient => 'Emerald Onion', url => 'https://emeraldonion.org'},
					{amount => '$44,663.88', recipient => 'Fight for the Future', url => 'https://www.fightforthefuture.org'},
					{amount => '$68,012.06', recipient => 'Freedom of the Press Foundation', url => 'https://freedom.press'},
					{amount => '$6,633.78', recipient => 'Freenet Project', url => 'https://freenetproject.org'},
					{amount => '$11,088.54', recipient => 'Internet Freedom Festival', url => 'https://internetfreedomfestival.org'},
					{amount => '$14,236.34', recipient => 'Let’s Encrypt', url => 'https://letsencrypt.org'},
				],
				col2 => [
					{amount => '$33,809.97', recipient => 'New Media Rights', url => 'https://www.newmediarights.org'},
					{amount => '$11,532.67', recipient => 'Open Source Technology Improvement Fund (OSTIF)', url => 'https://ostif.org'},
					{amount => '$9,078.78', recipient => 'Privacy Rights Clearinghouse', url => 'https://www.privacyrights.org'},
					{amount => '$32,903.87', recipient => 'Restore the Fourth', url => 'https://restorethe4th.com'},
					{amount => '$11,560.75', recipient => 'Riseup Labs', url => 'https://riseuplabs.org'},
					{amount => '$38,080.52', recipient => 'Tails', url => 'https://tails.boum.org'},
					{amount => '$18,895.49', recipient => 'Terms of Service; Didn’t Read', url => 'https://tosdr.org'},
					{amount => '$14,325.04', recipient => 'The Calyx Institute', url => 'https://www.calyxinstitute.org'},
					{amount => '$22,815.69', recipient => 'Tor Project', url => 'https://www.torproject.org'},
					{amount => '$4,263.78', recipient => 'World Privacy Forum', url => 'https://www.worldprivacyforum.org'},
				]
			}
		},{
			year => '2017',

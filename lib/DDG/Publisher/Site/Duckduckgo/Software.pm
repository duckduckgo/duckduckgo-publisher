...
sub pages {{
	"mozilla-firefox-portable" => sub {
		...
		product => {
			...
			dl => {
				size => '75MB',
				filename => 'FirefoxPortable/FirefoxPortable_61.0_English.paf.exe'
			},
			inst_size => '274MB',
			...
			details => {
				...
				'MD5 Hash' => 'a574a3bd7a4451dfdf82986076cf4653 (English)',
			}
		}
	},
	...
	"q-dir-portable" => sub {
		...
		product => {
			...
			dl => {
				size => '1MB',
				filename => 'Q-DirPortable/Q-DirPortable_7.07.paf.exe'
			},
			inst_size => '3MB',
			...
			details => {
				...
				'MD5 Hash' => '7cbb2e7394993b1067836a9a3f81e97b'
			}
		}
	},
